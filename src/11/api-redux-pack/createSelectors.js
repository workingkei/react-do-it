...
export default function createSelectors(resourceName) {
  ...
  // const collectionSelector = createSelector(entitiesSelector, pagesSelector, (entities, pages) =>
  ...
  const paginationSelector = createSelector(resourceSelector, ({ pagination }) => ({
